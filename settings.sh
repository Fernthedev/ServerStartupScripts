...
export LATEST_VERSION="$(curl -sLlf "https://papermc.io/api/v2/projects/paper/versions/${MCVER}" | jq '.builds[-1]')"
export DOWNLOAD_URL="https://papermc.io/api/v2/projects/paper/versions/${MCVER}/builds/${LATEST_VERSION}/downloads/paper-${MCVER}-${LATEST_VERSION}.jar"
